(function (root, factory) {
    ...
    (function (Backbone, _) {
        ...
        Wreqr.Commands = function (Wreqr) {
            ...
            return Wreqr.Handlers.extend({
                storageType: Wreqr.CommandStorage, constructor: function (options) {
                    this.options = options || {};
    ...
    Marionette.MonitorDOMRefresh = function (view) {
        ...
        view.on({show: handleShow, render: handleRender});
    };
    (function (Marionette) {
        'use strict';
    ...
    Marionette.Error = Marionette.extend.call(Error, {
        urlRoot: 'http://marionettejs.com/docs/v' + Marionette.VERSION + '/', constructor: function (message, options) {
            if (_.isObject(message)) {
                options = message;
    ...
    Marionette.Region = Marionette.Object.extend({
        constructor: function (options) {
            ...
            return this;
        }, triggerBeforeAttach: true, triggerAttach: true, _triggerAttach: function (views, prefix) {
    ...
    _.extend(Marionette.TemplateCache, {
        templateCaches: {}, get: function (templateId) {
    ...
    Marionette.CollectionView = Marionette.View.extend({
        childViewEventPrefix: 'childview', constructor: function (options) {
    ...
    Marionette.LayoutView = Marionette.ItemView.extend({
        regionClass: Marionette.Region, constructor: function (options) {
            options = options || {};
            ...
            var defaults = {regionClass: this.getOption('regionClass'), parentEl: _.partial(_.result, this, '$el')};
    ...
    _.extend(Marionette.Module.prototype, Backbone.Events, {
        startWithParent: true, initialize: function () {
